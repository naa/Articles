...
\begin{proof}
  ...
  \begin{equation}
    \label{eq:76}
    \sum_{i=0}^{M-1}\sum_{j=0}^{N-1}\varepsilon^{2}f\left(\varepsilon\sum_{k=-i}^{j}\varphi(k\varepsilon)\right)=
    \sum_{i=0}^{M-1}\sum_{j=0}^{N-1}\varepsilon^{2}f\left(\int_{-i\varepsilon}^{j\varepsilon}\varphi(x)\dx+\frac{\varepsilon}{2}\left(\varphi(j\varepsilon)-\varphi(-i\varepsilon)\right)+\mathcal{O}(\varepsilon^{2})\right)\dz\dy
  \end{equation}
...
\begin{equation}
  ...
  \int_{0}^{a}\int_{0}^{b}G_{0}(y,z)\dz\;\dy+\int_{0}^{a}\int_{0}^{b}\frac{\varepsilon}{2}(\varphi(z)-\varphi(-y))\cdot f'\left(\int_{-y}^{z}\varphi(x)\dx\right)\dz\;\dy+o(\varepsilon)
\end{equation}
...
\begin{equation}
  \label{eq:61}
  f^{(0)}=\frac{1}{ab}\sum_{n=1}^{\infty} \frac{\tilde{\chi}\left(n\varepsilon
      \varphi(b-a),\varepsilon\right) }{n^{3}\varphi(b-a)^{2}},
\end{equation}
where $\tilde{\chi}(z,\varepsilon)$  is defined as
\begin{equation}
  \label{eq:62}
  \tilde{\chi}(z,\varepsilon)\equiv \frac{z^{2} e^{-z}
...
\begin{multline}
  ...
  \frac{1}{n^{3}}\left[
    \left.\tilde{\chi}''_{\varepsilon\varepsilon}\left(n\varepsilon\varphi(b-a),\varepsilon\right)\right|_{\varepsilon=0}+
    2n\varphi(b-a)\left.\tilde{\chi}''_{z\varepsilon}\left(n\varepsilon\varphi(b-a),\varepsilon\right)\right|_{\varepsilon=0}+\right.\\\left.
      n^{2}\left(\varphi(b-a)\right)^{2}\tilde{\chi}''_{zz}\left(n\varepsilon\varphi(b-a),\varepsilon\right)  \right]+
    \mathcal{O}(\varepsilon \ln \varepsilon)=\\
    =\frac{1}{ab\varphi(b-a)}\left[\sum_{n=1}^{\infty} \frac{1}{n^{3}}
      \tilde{\chi}''_{\varepsilon\varepsilon}(0,0)+2\varphi(b-a)\sum_{n=1}^{\infty}\frac{1}{n^{2}}\tilde{\chi}''_{z\varepsilon}(0,0)\right]+
    \\
...
\end{equation}
we see that $\Psi_{n}(0)=0$ and $\Psi_{n}'(0)=0$.
Than in the limit $n\to\infty$ we have
\begin{equation}
  \label{eq:69}
  \int_{0}^{c}\Psi_{n}(x)
  \dx \xrightarrow[n\to\infty]{}\int_{0}^{c}e^{-nxr'(0)}\left(-nx^{2}\zeta(x)+\dots\right)\sim \frac{1}{n^{2}}
\end{equation}
...
\begin{equation}
  ...
  \left(\varepsilon\int_{0}^{a} \Psi_{n}^{+}(x) \dx -\varepsilon^{2} \Psi_{n}^{+}(a) +\varepsilon^{3}\Psi^{+'}_{n}(0)\right)\right|_{\varepsilon=0}
\end{equation}
...
\begin{equation}
 ...
 \left(\varepsilon\int_{0}^{b} \Psi_{n}^{-}(x) \dx -\varepsilon^{2} \Psi_{n}^{-}(a) +\varepsilon^{3}\Psi^{-'}_{n}(0)\right)\right|_{\varepsilon=0}
\end{equation}
At last, we need to consider $f^{\times}$. In this term we can just take a limit $\varepsilon\to 0$
and obtain
\begin{multline}
  \label{eq:73}
...
\begin{multline}
  ...
  +\frac{1}{ab}\left(\frac{1}{8} +\frac{1}{2} \int_{0}^{\infty}
    e^{-z}q(z) \dz\right),
\end{multline}
Here in the first line we have the contributions that depend on the choice of the weight function
...
\begin{tabular}{c|cccccc}
 ...
 \hline
 analytic & $\frac{1}{3}(2+\cos(z))$ & 1,3 & $0.472206688$ & $0$ & $1$&$-0.043883000$\\
 numeric & $\frac{1}{3}(2+\cos(z))$ & 1,3 &  $0.472206693$ & $0.000000730$ & $1.000730689$&$-0.043827958$\\
  \hline
 analytic & $\frac{1}{3}(2+\cos(z))$ & 2,3 & $0.235922467$ & $0$ & $1$&$-0.030398000$\\
 numeric & $\frac{1}{3}(2+\cos(z))$ & 2,3 &  $0.235922467$ & $0.000000044$ & $1.000088528$&$-0.030394694$\\
\hline                                                
...
will also further discuss the description of the model by boundary conformal field theory.

\section*{Acknowledgments}
\label{sec:acknowledgements}
We are grateful to professor Nikolai Reshetikhin for his attention to this work. We thank Pavel Belov
for useful discussions and general support.

We thank the organizers and participants of the conference MQFT-2018 for the opportunity
