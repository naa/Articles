...
Consider the embedding $\widehat{su(2)\oplus su(2)}\subset \hat{su(4)}$, which is the affine extension of the special embedding $su(2)\oplus su(2)\subset su(4)$. Let's construct the special embedding $su(2)\oplus su(2)\subset su(4)$ using the method of \cite{vasilevich1986method}. We start with 4-dimensional representation of $su(2)\oplus su(2)$ with the highest weight $(1,1)$.


, depicted at the Figure \ref{fig:a1a2a3}. This embedding is characterised by the embedding indexes $(2,2)$ and is conformal, since $c(A_1\oplus A_1)=c(A_1)+c(A_1)=2\frac{x_e \mathrm{dim}(A_1)}{x_e+2}=\frac{\mathrm{dim}A_3}{5}=c(A_3)$.
...
The set of the anomalous weights of the representation of the algebra $\hat{A}_3$ consists of 192 elements.
