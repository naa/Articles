...
It is important that the projection of some of positive roots of
...
\item Calculate the anomalous branching coefficients in the main Weyl
  chamber of the subalgebra $\mathfrak{a}$ using the recurrent relation (\ref{recurrent-relation}).
\end{enumerate}
...
\subsubsection{Affine into affine embedding}
...
The set of the anomalous weights of this representation  is depicted in the Figure \ref{fig:affine_A2_anom_point} up to the sixth grade. We also show the root subspace of the subalgebra $\hat{A}_1$ under consideration as the dotted diagonal plane.
...
The next step is to project the anomalous weights to $P_{\aht A_1}$.
