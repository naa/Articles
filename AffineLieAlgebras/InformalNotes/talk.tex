...
Общая идея метода состоит в том, чтобы разделить описание ветвления на две части --- описание
вложения и описание представления, которое раскладывается. Затем каждая из частей описывается 
