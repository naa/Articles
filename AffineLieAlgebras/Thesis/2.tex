...
Теперь мы выполним разложение сингулярного элемента  $\Psi ^{\left(\mu \right) }$ на сингулярные элементы модулей ортогонального партнера. Это разложение в целом аналогично разложению в Лемме \ref{lemma}, однако в данном случае его составляющими являются сингулярные элементы ортогонального партнера $\afb$.
