...
Author consider polygons with generating function
\begin{equation}
  \label{eq:75}
...
\end{equation}
But reasoning is quite strange and unsound. 
...
$B_{-b}$. The fusion of $B_{0}=I$ to $V_{\alpha}$ is $\left<V_{\alpha}(x)
  B_{0}(0)\right>=\frac{R(\alpha,0|\mu_{B})}{|z-\bar z|^{2\Delta_{\alpha}}}$, and the fusion of $V_{-\frac{b}{2}}$ 
