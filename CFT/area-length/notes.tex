...
\begin{multline}
\label{eq:181}
  S[\chi,\varphi]=\int_{\mathcal{M}}\sqrt{g}\left(\frac{1}{4\pi}[(\nabla \varphi)^{2}+(\nabla
    \chi)^{2}]+\mu e^{2b\varphi}\right)d^{2}z +\\
  +  \int_{\partial
    \mathcal{M}}g^{\frac{1}{4}}\left(\frac{1}{2\pi}(Q\varphi-ie_{0}\chi)\hat K + \mu_{B}e^{a\varphi}\right)dx+\mbox{ghosts}
\end{multline}
Let $\mathcal{M}=\mathbb{D}$ and $g_{\mu\nu}=\delta_{\mu\nu}$. Then the background geodesic curvature is $\hat K=1$ and action is
\begin{multline}
  \label{eq:182}
...
\begin{equation}
  \label{eq:183}
  S_{\tilde g}[\chi,\varphi]=\int_{\mathbb{D}} e^{\sigma} \left( \frac{1}{4\pi} e^{\sigma}\left[ (\nabla
